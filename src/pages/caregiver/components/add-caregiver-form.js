...
class AddCaregiverForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formControls: {
                name: {
                    value: '',
                    placeholder: 'The caregiver\'s name',
                    valid: false,
                    touched: false,
                    validationRules: {
                        minLength: 3,
                ...
                birthDate: {
                    value: '',
                    placeholder: 'The caregiver\'s birth date',
                    valid: false,
                    touched: false,
                    validationRules: {
                        dateValidator: true
                ...
                address: {
                    value: '',
                    placeholder: 'The caregiver\'s home address',
                    valid: false,
                    touched: false,
                    validationRules: {
                        minLength: 3,
    ...
    registerCaregiver(caregiverDTO) {
        return API_CAREGIVERS.insertCaregiver(caregiverDTO, (result, status, error) => {
    ...
    handleSubmit() {
        ...
        this.registerCaregiver(caregiverDTO);
    }
